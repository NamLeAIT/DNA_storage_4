...
def render_ngs():
    ...
    if run_btn and seq:
        ...
        st.session_state["ngs_fastq_exports"] = None
        st.session_state["ngs_sim_result"] = None
        st.session_state["ngs_latest_exports"] = {"prep_result": result, "prep_exports": exports}
...
─── 3'""",
        ...
        with st.container(border=True):
            ...
            if sim_btn:
                ...
                st.session_state["ngs_latest_exports"] = {"prep_result": result, "prep_exports": exports, "sim_result": sim, "sim_exports": sim_exports}
